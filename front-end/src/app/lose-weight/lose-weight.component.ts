...
@Component({
  ...
  styleUrl: './lose-weight.component.css'
})
export class LoseWeightComponent {
    ...
    caloriesMinNumber(){
      return this.bodyW*24;
    }
  
    caloriesMaxNumber(){
      return this.bodyW*26;
    }

    calcFatsMin1(){
      return Math.round((11.2 * this.bodyW)/9);
    }
  
    calcFatsMin2(){
      return Math.round((9.6 * this.bodyW)/9); 
    }
  
    calcFatsMin3(){
      return Math.round((8 * this.bodyW)/9);
    }
  
    calcFatsMin4(){
      return Math.round((6.4 * this.bodyW)/9);
    }
  
    calcFatsMax1(){
      return Math.round((13.2 * this.bodyW)/9);
    }
  
    calcFatsMax2(){
      return Math.round((11.6 * this.bodyW)/9);
    }
  
    calcFatsMax3(){
      return Math.round((10 * this.bodyW)/9);
    }
  
    calcFatsMax4(){
      return Math.round((8.4 * this.bodyW)/9);
    }
