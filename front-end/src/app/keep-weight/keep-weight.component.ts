...
@Component({
  selector: 'app-keep-weight',
  imports: [FormsModule],
  templateUrl: './keep-weight.component.html',
  styleUrl: './keep-weight.component.css'
})
export class KeepWeightComponent {
  bodyW!: number;
  fatsNum: number = 0;
  ...
  caloriesMinNumber(){
    return this.bodyW*30;
  }

  caloriesMaxNumber(){
    return this.bodyW*33;
  }

  calcFatsMin1(){
    return Math.round((17.2 * this.bodyW)/9);
  }

  calcFatsMin2(){
    return Math.round((15.6 * this.bodyW)/9); 
  }

  calcFatsMin3(){
    return Math.round((14 * this.bodyW)/9);
  }

  calcFatsMin4(){
    return Math.round((12.4 * this.bodyW)/9);
  }

  calcFatsMax1(){
    return Math.round((20.2 * this.bodyW)/9);
  }

  calcFatsMax2(){
    return Math.round((18.6 * this.bodyW)/9);
  }

  calcFatsMax3(){
    return Math.round((17 * this.bodyW)/9);
  }

  calcFatsMax4(){
    return Math.round((15.4 * this.bodyW)/9);
  }
